---
title: "Reglas de asociación (y detección de anomalías) con futbolistas usando R"
author: ''
date: '2020-04-05'
tags: ['futbol']
editor_options: 
...
![](\posts\20200405_reglas_asociacion\fifa.png)
...
![](\posts\20200405_reglas_asociacion\soldado.png)
...
Tanto el conjunto de datos como el preprocesamiento realizado se omite en esta publicación, aunque está disponible en [GitHub](https://github.com/danielredondo/danielredondo.com/tree/master/content/posts).

```{r, include = FALSE}
# Lectura del conjunto de datos
load(file = "20200405_reglas_asociacion/futbin.RData")
futbin <- tabla
